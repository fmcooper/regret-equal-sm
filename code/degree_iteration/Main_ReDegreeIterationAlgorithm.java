...
/**
*	Finds the regret-equal stable matching using the Regret-Equal Degree
* Iteration Algorithm for a single instance. </p>
*
* @author Frances
*/

public class Main_ReDegreeIterationAlgorithm {
	...
	*/
	public static void helpAndExit() {
		...
		+ "using the Regret-Equal Degree Iteration Algorithm for a single "
		+ "instance.\n\n"
		+ "Using this program:\n"
		+ "$ java Main_ReDegreeIterationAlgorithm [-h] <instance file name>";
	...
	*/
	public static void main(String args[]) {
		...
		ReDegreeIterationAlgorithm reAlg = new ReDegreeIterationAlgorithm(
			model);
